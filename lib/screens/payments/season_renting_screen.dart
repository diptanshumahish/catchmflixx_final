...
SeasonRentModel rt = SeasonRentModel(success: false);

class SeasonRentingScreen extends StatefulWidget {
  ...
  @override
  State<SeasonRentingScreen> createState() => _SeasonRentingScreenState();
}

class _SeasonRentingScreenState extends State<SeasonRentingScreen> {
  @override
  void initState() {
    super.initState();
    getData();
  ...
  Future<void> getData() async {
    ...
    final data = await p.getSeasonRents(widget.id);
                                      ...
                                      children: [
                                        ...
                                        OffsetFullButton(
                                          ...
                                          fn: () async {
                                            PaymentsManager p = PaymentsManager();
                                            final data = await p
                                                .phonePeInitSeason(ele.id.toString());
